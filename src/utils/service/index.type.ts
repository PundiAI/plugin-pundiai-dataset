...
export interface QueryDownloadedUrlOutput {
  downloadUrl?: string
  expiredTime?: number
  /** @description file size */
  size?: number
}
export interface QueryUsageRightMakerAskOutput {
  amount?: string
  blockNumber?: number
  ...
  startTime?: number
  strategyId?: string
  usageRightOrderNonce?: string
}
export interface RespListQueryDownloadedUrlOutput {
  code?: number
  data?: QueryDownloadedUrlOutput[]
  msg?: string
}
...
export interface RespQueryUsageRightMakerAskOutput {
  code?: number
  data?: QueryUsageRightMakerAskOutput
  msg?: string
}
...
export interface GetV1ViewQueryDownloadedUrlQuery {
  /** @description requester */
  requester: string
  /** @description nft tokenId */
  tokenId: string
}
export interface GetV1ViewQueryUsageRightMakerAskQuery {
  /** @description nft contract */
  contractAddress: string
  /** @description nft tokenId */
  tokenId: string
